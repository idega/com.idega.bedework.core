...
public interface CoreCalendarsI extends Serializable {
  ...
  /** Get the root or home calendar path for the given principal. This is determined
   ...
   * @throws CalFacadeException
   */
  public String getPrincipalRootPath(BwPrincipal principal) throws CalFacadeException;
