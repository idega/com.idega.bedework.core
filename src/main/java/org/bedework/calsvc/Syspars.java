...
class Syspars extends CalSvcDb implements SysparsI {
  ...
  Syspars(final CalSvc svci, final BwUser user,
  ...
  public BwSystem get(final String name) throws CalFacadeException {
    ...
    BwSystem sys = (BwSystem)sess.getUnique();
  ...
  /* (non-Javadoc)
   * @see org.bedework.calsvci.SysparsI#isRootUser(org.bedework.calfacade.BwUser)
   */
  public boolean isRootUser(final BwUser val) throws CalFacadeException {
