...
public class FilterBuilder {
  ...
  private static class OrCalFilter extends CalFilter {
  ...
  public FilterBase buildFilter(final List<String> paths,
    ...
    for (String path: paths) {
      ...
      if (calFilter != null) {
        mergeFilter(ocf.terms, calFilter);
      }
    }

    if (ocf.terms.isEmpty()) {
      // No valid matches
  ...
  private void mergeFilter(final Collection<CalFilter> terms,
                           final CalFilter cf) throws CalFacadeException {
