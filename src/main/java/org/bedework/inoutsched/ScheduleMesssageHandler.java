...
/** Something that handles scheduling messages. They can be for incoming or
 * outbound.
 *
 * @author Mike Douglass
 *
 */
public interface ScheduleMesssageHandler {
  /** */
  public enum ProcessMessageResult {
    ...
    /** Something changed and caused a statel state exception. Should retry */
    STALE_STATE
  }
  /**
   * @param msg
